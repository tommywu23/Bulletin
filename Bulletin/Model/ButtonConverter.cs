...
namespace Bulletin.Model
{
    public class ButtonConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            result = System.IO.Path.Combine(App.CONFIGPATH, "Resource/Images", @"button" + value.ToString() + ".png");
            return result;
        }
    ...
    public class ButtonBackConverter : IValueConverter
    {
        ...
        {
            string result = string.Empty;
            result = System.IO.Path.Combine(App.CONFIGPATH, "Resource/Images", @"buttonback" + value.ToString() + ".png");
            return result;
        }
